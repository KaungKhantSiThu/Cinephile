...
public final class Status: AnyStatus, Codable, Identifiable, Equatable, Hashable {
    ...
    public static func placeholder(forSettings: Bool = false, language: String? = nil) -> Status {
        .init(id: UUID().uuidString,
              ...
              entertainments: [
                .init(id: 1, domain: "themoviedb.org", mediaType: .movie, mediaId: "507086", watchStatus: true),
                .init(id: 2, domain: "themoviedb.org", mediaType: .tvSeries, mediaId: "90802", watchStatus: true)
              ]
        )
    }
